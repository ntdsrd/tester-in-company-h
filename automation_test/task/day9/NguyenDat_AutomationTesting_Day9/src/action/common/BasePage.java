...
public class BasePage {
    ...
    //verify equal
    public boolean verifyEqual(String actual, String expected) {
        try {
    ...
    //press key by send key
    public void ctrlZ(WebDriver driver, String locator, Keys key, String board, String... params) {
        getDynamicElement(driver, locator, params).sendKeys(Keys.chord(key, board));
    }
...
//        waitForElementClickable(driver, locator);
    ...
    //clear element by dynamic locator
    public void clearElementByDynamicLocator(WebDriver driver, String locator, String... params) {
//        waitForElementVisible(driver, locator);
